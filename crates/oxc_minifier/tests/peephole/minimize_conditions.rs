...
fn test_fold_one_child_blocks() {
    ...
    test("if(x){ if(y){var x;}else{var z;} }", "if(0)var x,z");
    ...
    test("if(x){ if(y){var x;}else{var z;} }else{var w}", "if(0)var x,z;else var w");
    test("if (x) {var x;}else { if (y) { var y;} }", "if(0)var x;else if(0)var y");
