...
fn minimize_conditional_exprs() {
    ...
    test("a ? b || c : c", "(a && b) || c");
    test("a ? c : b && c", "(a || b) && c");
    test("var a, b; a ? b(c, d) : b(e, d)", "var a, b; b(e, d)");
    test("var a, b; a ? b(...c) : b(...e)", "var a, b; b(...e)");
    test("var a, b; a ? b(c) : b(e)", "var a, b; b(e)");
    test("var a, b; a ? b() : b()", "var a, b; b()");
    test("var a, b; a === 0 ? b(c) : b(e)", "var a, b; b(e)");
    test("var a; a === 0 ? b(c) : b(e)", "var a; b(e)");
    ...
    test_target("var a; v = a != null ? a : b", "var a; v = b", "chrome79");
    test("var a; v = a != null ? a.b.c[d](e) : undefined", "var a; v = void 0");
    ...
    test("var a, undefined = 1; v = a != null ? a.b.c[d](e) : undefined", "var a; v = 1");
    test_target("var a; v = a != null ? a.b.c[d](e) : undefined", "var a; v = void 0", "chrome79");
